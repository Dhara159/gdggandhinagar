        ...
        <v-layout wrap align-center justify-center row fill-heights>
            ...
            <v-flex xs12 sm12 md12 lg12 xl12 order-xs2 order-md1 class="pa-5">
               <p class="google-font mb-1" style="font-weight: 350;color: #616161;font-size:200%"><b>Our   
                ...
                <p class="google-font mt-0" style="font-size:120%">If you’re interested in being showcased throughout <b>GDG DevFest Gandhinagar 2019</b>, contact <a style="color:#1565C0;text-decoration: none;" href="mailto:devfestpunjab@gmail.com">devfestpunjab@gmail.com</a> to discuss sponsorship opportunities.</p>
            </v-flex> 
        </v-layout>
    </v-container>
</template>
